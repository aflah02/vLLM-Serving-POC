...
#SBATCH -D ./
#SBATCH -J 70b-alpha-tp-8-pp-1-cust-pg
...
save_path="/ptmp/afkhan/vLLM-Serving-POC/Data/Outputs_Llama-3.1-70B-Instruct_OHB_Chat_Alpha_tp_8_pp_1_with_custom_placement_group.json"
...
python main_with_ray_placement_group.py --model $model --tp_size $tp_size --pp_size $pp_size --save_path $save_path --queries_path $queries_path --prompt_path $prompt_path
