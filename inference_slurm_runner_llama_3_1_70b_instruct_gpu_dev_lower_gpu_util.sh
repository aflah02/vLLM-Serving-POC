...
python main.py --model $model --tp_size $tp_size --pp_size $pp_size --save_path $save_path --queries_path $queries_path --prompt_path $prompt_path --gpu_memory_utilization $gpu_memory_utilization
